package com.polyakov.androidgithubclient.view.widgets;
 ...
 * 12.10.2016.
 *
 * ViewPager for images in the starting of the app
 * @see com.polyakov.androidgithubclient.view.activities.ImagesActivity
 */
